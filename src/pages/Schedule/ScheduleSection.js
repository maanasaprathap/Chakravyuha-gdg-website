        ...
        <div className="table_container">
          <table className="schedule_table">
            <tbody>
              ...
              <tr>
                <td rowSpan="5" className="row_1">BLANK SPACE</td>
              ...
              <tr>
                <td rowSpan="3" className="row_1">YOU & I</td>
              ...
              <tr>
                <td rowSpan="2" className="row_1">CODER-VERSE</td>
              ...
              <tr>
                <td rowSpan="2" className="row_1">HUSTLERS HARMONY</td>
              ...
              <tr>
                <td rowSpan="3" className="row_1">ADS DON'T LIE</td>
              ...
              <tr>
                <td rowSpan="3" className="row_1">TRIVIA FIESTA</td>
                <td>ROUND 1 (02/11/2023)</td>
              ...
              <tr>
                <td rowSpan="2" className="row_1">ALAIPADUTHEY</td>
                <td>ROUND 1 (02/11/2023)</td>
              ...
              <tr>
                <td rowSpan="1" className="row_1">GAMING (VALORANT)</td>
                <td>Round 1(ONLINE)(01/11/2023)</td>
                <td>will be intimated soon</td>
              </tr>
              <tr>
                <td rowSpan="2" className="row_1">THE KNIGHT CHANGES</td>
                <td>ROUND 1(ONLINE) (31/10/2023)</td>
