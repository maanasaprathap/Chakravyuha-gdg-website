                ...
                <div id="event-details">
                    ...
                    <div className="event-top">
                        <div id="event-title-info">
                            ...
                            <div id="event-description"><b>Mode: <i style={{color: "#a855f7"}}>{eventDetail.mode}</i></b></div>
                            {eventDetail.venue ? (     
                    ...
                    <div className="event-bottom">
                        ...
                        <div id="event-description">
                            <b>Last date for registration: <i style={{color: "#a855f7"}}>{eventDetail.eventCloseDate}</i></b>
                        </div>

                        <div id="query" style={{ marginRight: "4px", fontSize: "14px" }}><b style={{color: "#a855f7"}}>For queries, contact:</b></div>
